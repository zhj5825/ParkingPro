package com.yxzz.parkingpro.providers;
...
import com.yxzz.parkingpro.protocol.GooglePlaceDetailsJSONParser;
import com.yxzz.parkingpro.protocol.GooglePlaceJSONParser;
...
public class GooglePlaceProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        GooglePlaceJSONParser parser = new GooglePlaceJSONParser();
        GooglePlaceDetailsJSONParser detailsParser = new GooglePlaceDetailsJSONParser();
        ...
        case SEARCH:
            ...
            parser = new GooglePlaceJSONParser();
 
            // Create a parser object to parse place details in JSON format
            detailsParser = new GooglePlaceDetailsJSONParser();
